...
# Compiler lib
libwavecompiler.a: wave_path.o wave_atom.o wave_collection.o | lib_dir
		ar -crv $(PATH_LIB)/libwavecompiler.a $(PATH_OBJ)/wave_path.o $(PATH_OBJ)/wave_atom.o $(PATH_OBJ)/wave_collection.o
