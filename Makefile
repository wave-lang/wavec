...
wave_length.o: wave_length.c wave_length.h
...
wave_int_list.h wave_coordinate.h wave_length.h
...
libwavecompiler.a: wave_types.o wave_operator.o wave_path.o wave_atom.o \
	wave_collection.o wave_phrase.o wave_int_list.o wave_length.o wave_coordinate.o wave_collection_info.o | lib_dir
	ar crvs $(PATH_LIB)/libwavecompiler.a $(PATH_OBJ)/wave_types.o \
		...
		$(PATH_OBJ)/wave_coordinate.o $(PATH_OBJ)/wave_length.o \
		$(PATH_OBJ)/wave_collection_info.o
